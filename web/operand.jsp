...
<html>
	<head>
		...
		<title>cdn.SwGhosh.tk | Chapter Operand</title>
  	...
  	<body>
		<script type="text/javascript">alert("Welcome to \"Chapter Operand\".\nWe will show you something interesting!\nNow watch your Operating System talking to you...");</script>
		...
		<p class="imported">NOTE: This page will never load a second thing, inspite of the loading logo above!!</p>
	</body>
</html>
